...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            style={'width':'80%', 'padding':'3px', 'font':'20px', 'text-align-left':'centre'}
        )
    ]),
...
def update_output_container(val, data):
    if val == 'Recession Period Statistics':
...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        yearly_rec=recession_data.groupby('City')['Automobile_Sales'].mean().reset_index()
        R_chart1 = dcc.Graph(
            figure=px......(....., 
                x='Recession',
                y='Automobile_Sales',
